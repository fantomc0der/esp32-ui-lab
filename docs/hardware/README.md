...
Cross-checked across three sources (Waveshare wiki, their ESP-IDF BSP headers, and a working community sketch); per-pin citations live in [`board_pins.h`](../../firmware/boards/waveshare-s3-touch-147/board_pins.h).
