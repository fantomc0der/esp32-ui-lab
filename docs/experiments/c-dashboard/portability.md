...
| Other ESP32-S3 + ST7789-family SPI panel | New `board_pins.h`; drop or replace the JD9853 blob; adjust W/H/offsets; re-measure touch mapping ([touch.md](../../hardware/touch.md)); retune layout constants. |
