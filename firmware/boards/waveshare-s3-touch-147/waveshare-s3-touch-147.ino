...
// touch, and LVGL, then hands the screen to JavaScript executed by QuickJS-ng.
//
...
// reload, and what the serial port does. Build with flash.ps1 at the repo root.
...
// ---------------------------------------------------------------- display stack
// Identical to experiments/c-dashboard/app, where it was first proven — see
// docs/hardware/ for the reasoning behind every constant here.
